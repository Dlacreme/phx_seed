defmodule ToReplaceWeb do
  ...
  def controller do
    quote do
      use Phoenix.Controller, namespace: ToReplaceWeb
  ...
  def view do
    quote do
      use Phoenix.View,
        root: "lib/toreplace_web/templates",
        namespace: ToReplaceWeb
  ...
  def live_view do
    quote do
      use Phoenix.LiveView,
        layout: {ToReplaceWeb.LayoutView, "live.html"}
